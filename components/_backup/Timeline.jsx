  ...
  return (
    <li ref={ref} className="tl-item" data-current={t.current ? "1" : "0"} data-last={i === total - 1 ? "1" : "0"}>
      ...
      <m.div
        ...
        <div className="tl-org" style={{ width: "136px" }}>{t.org}</div>
      </m.div>
      ...
      <m.div
        ...
        <h3 className="tl-role">
          {t.role}
          {t.current && <span className="tl-badge">Now</span>}
        </h3>
    ...
    <section id="projects">
      <div className="sect-head">
        ...
        <h2 className="sect-title">
          What I've been <em>building.</em>
        </h2>
        <p className="sect-lede">
          A short trajectory of roles and the work behind them. Happy to dive deeper into any of these on a call.
        </p>
      </div>
